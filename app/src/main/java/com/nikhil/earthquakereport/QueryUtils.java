...
public class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONObject baseJsonResoponse = new JSONObject(SAMPLE_JSON_RESPONSE);
            JSONArray earthquakeArray = baseJsonResoponse.getJSONArray("features");
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                Earthquake earthquake = new Earthquake(magnitude, place,date , time, url);
